...
function switchTab(clickedTab) {
  ...
  if (clickedTab !== currentTab) {
    ...
    currentTab.classList.add("current-tab");
    // current tab is user weather tab and user wants to go from user tab to city tab.
    if (!searchForm.classList.contains("active")) {
      ...
      {
        // current tab is search city tab and user wants to go from city tab to user tab.
